...
public class CombinedXYPlotDemo extends ApplicationFrame {
     ...
     */
    public CombinedXYPlotDemo(final String title) {
    ...
    private JFreeChart createCombinedChart() {
        ...
        final TimeSeries eur = null;//DemoDatasetFactory.createEURTimeSeries();
    ...
    public static void main(final String[] args) {
        ...
        final CombinedXYPlotDemo demo = new CombinedXYPlotDemo("Combined XY Plot Demo 3");
        demo.pack();
